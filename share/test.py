...
voters_instances[0].call_method_signed('get_my_vote', {'eid': eid})
ts4.dispatch_messages()
answer = voters_instances[0].call_getter('m_my_vote')
print(answer)

voters_instances[0].call_method_signed('get_my_vote', {'eid': '4321'})
ts4.dispatch_messages()
answer = voters_instances[0].call_getter('m_my_vote')
print(answer)
