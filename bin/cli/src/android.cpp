...
extern "C" JNIEXPORT void JNICALL Java_com_devote_DeVoteJNI_generateVoterKeypair(JNIEnv *env,
                                                                                 jobject thiz,
                                                                                 jbyteArray pk_out,
                                                                                 jbyteArray sk_out) {
...
extern "C" JNIEXPORT void JNICALL Java_com_devote_DeVoteJNI_generateVote(
    JNIEnv *env, jobject thiz, jint tree_depth, jint eid_bits, jint voter_idx, jint vote, jbyteArray merkle_tree_buffer,
    jbyteArray rt_buffer, jbyteArray eid_buffer, jbyteArray sk_buffer, jbyteArray pk_eid_buffer,
    jbyteArray r1cs_proving_key_buffer, jbyteArray r1cs_verification_key_buffer, jbyteArray proof_buffer_out,
    jbyteArray pinput_buffer_out, jbyteArray ct_buffer_out, jbyteArray sn_buffer_out) {
...
extern "C" JNIEXPORT jboolean Java_com_devote_DeVoteJNI_verifyTally(
    JNIEnv *env, jobject thiz, jint tree_depth, jobjectArray cts_buffer_array, jbyteArray vk_eid_buffer,
    jbyteArray pk_crs_buffer, jbyteArray vk_crs_buffer, jbyteArray dec_proof_buffer, jbyteArray voting_res_buffer) {
